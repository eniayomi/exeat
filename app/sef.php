<?php include('../includes/exeatdb.php') ?>
<!DOCTYPE html>
<html>
<head>
	<title>Short Exeat Form</title>
...
<body>
	...
	<div class="ssignup">
		<h2>Short Exeat Form</h2>
	</div>
	
	<form method="post" action="sef.php">
		...
		<div class="input-group">
			...
			<input type="time" name="toa" value="<?php echo $toa; ?>">
		</div>
		<div class="input-group">
